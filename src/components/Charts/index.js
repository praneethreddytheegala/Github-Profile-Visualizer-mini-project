      ...
      <StyledWrapper>
        <StyledChartContainer>
          ...
          <div className="chart-data">
            {langChartError && (
              <StyledDescription>Nothing to see here!</StyledDescription>
            )}
        ...
        <StyledChartContainer>
          ...
          <div className="chart-data">
            {starChartError && (
              <StyledDescription>
                Nothing about language data to show!
              </StyledDescription>
            )}
        ...
        <StyledChartContainer>
          ...
          <div className="chart-data">
            {doughnutChartError && (
              <StyledDescription>
                Nothing about repository data to show!
              </StyledDescription>
            )}
